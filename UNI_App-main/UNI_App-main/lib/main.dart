...
import 'package:uni/view/Pages/class_schedule_list_view.dart';
      ...
      child: MaterialApp(
          ...
          onGenerateRoute: (RouteSettings settings) {
            switch (settings.name) {
              ...
              case '/' + Constants.navClassScheduleList:
                return PageTransition.makePageTransition(
                    page: ClassScheduleListView(), settings: settings);
              case '/' + Constants.navBugReport:
                return PageTransition.makePageTransition(
                    page: BugReportPageView(),
                    settings: settings,
                    maintainState: false);
              case '/' + Constants.navPersonalSchedule:
                return PageTransition.makePageTransition(
                    page: PersonalScheduleView(), settings: settings);
